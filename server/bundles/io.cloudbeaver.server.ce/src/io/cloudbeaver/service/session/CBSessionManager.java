...
public class WebSessionManager implements AppWebSessionManager {
     ...
     */
    @Nullable
    private WebSession getOrRestoreWebSession(@NotNull WebHttpRequestInfo requestInfo) {
    ...
    @Nullable
    public WebHeadlessSession getHeadlessSession(@Nullable String smAccessToken, @NotNull WebHttpRequestInfo requestInfo, boolean create) throws DBException {
    ...
    public BaseWebSession getOrRestoreSession(@NotNull WebHttpRequestInfo requestInfo) {
        var webSession = getOrRestoreWebSession(requestInfo);
        if (webSession != null) {
            webSession.updateSessionParameters(requestInfo);
            return webSession;
        }
        // possible desktop client session
//        var headlessSession = createHeadlessSession(requestInfo);
