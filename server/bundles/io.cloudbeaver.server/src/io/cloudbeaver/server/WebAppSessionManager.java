...
public interface WebAppSessionManager {
    ...
    BaseWebSession getOrRestoreSession(@NotNull WebHttpRequestInfo requestInfo);

    WebHeadlessSession getHeadlessSession(@Nullable String smAccessToken, @NotNull WebHttpRequestInfo requestInfo, boolean create) throws DBException;
