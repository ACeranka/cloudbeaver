...
import io.cloudbeaver.server.websockets.EchoServerEndpoint;
...
public class CBJettyWebSocketContext implements DBWWebSocketContext {
    ...
    @Override
    public void addWebSocket(@NotNull String mapping, @NotNull ServerEndpointConfig.Configurator configurator) {
